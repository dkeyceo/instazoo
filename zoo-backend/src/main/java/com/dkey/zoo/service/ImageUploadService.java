...
import com.dkey.zoo.exceptions.ImageNotFoundException;
...
public static final Logger LOG = LoggerFactory.getLogger(ImageUploadService.class);
	...
	@Autowired
	public ImageUploadService(PostRepository postRepository, ImageRepository imageRepository, UserService userService) {
