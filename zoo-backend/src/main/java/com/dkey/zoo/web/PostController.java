...
import com.dkey.zoo.facade.PostFacade;
import com.dkey.zoo.facade.UserFacade;
import com.dkey.zoo.payload.response.MessageResponse;
import com.dkey.zoo.service.PostService;
...
public class PostController {
    ...
    public ResponseEntity<PostDTO> likePost(@PathVariable("postId") String postId,
        ...
        return new ResponseEntity<>(postFacade.postToPostDTO(post), HttpStatus.OK);
    }
